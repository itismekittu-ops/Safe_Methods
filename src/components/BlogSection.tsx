...
export function BlogSection() {
  return <section id="blog" className="container mx-auto px-4 py-16 md:py-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {posts.map((post, idx) => <Card key={idx} className="overflow-hidden flex flex-col bg-surface border border-border-subtle">
            ...
            <div className="p-6 flex flex-col flex-grow">
              ...
              <Link to="/blog" className="text-sm font-medium text-primary hover:text-accent transition-colors mt-auto">
