...
export function SafeBotDemo() {
  return <section className="container mx-auto px-4 py-16 md:py-24 bg-surface border-y border-border-subtle">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
        {pillars.map((pillar, idx) => <div key={idx} className="bg-background border border-border-subtle rounded-lg p-6 flex flex-col items-center text-center hover:border-border transition-colors">
