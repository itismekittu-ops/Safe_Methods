...
const sizeClasses: Record<LogoSize, {
  container: string;
  icon: string;
  text: string;
}> = {
...
export function Logo({
  ...
  return <div className={`flex items-center ${s.container} ${className}`}>
      <div className={`${s.icon} flex items-center justify-center bg-primary rounded-lg shrink-0`}>
        <svg viewBox="0 0 24 24" fill="none" className="w-2/3 h-2/3">
          <path d="M12 2L3 7v6c0 5.5 3.8 10.7 9 12 5.2-1.3 9-6.5 9-12V7l-9-5z" stroke="#D4AF37" strokeWidth="1.5" fill="none" />
