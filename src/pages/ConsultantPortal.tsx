  ...
  async function loadBidContext() {
    try {
      ...
      const response = await fetch(`${supabaseUrl}/functions/v1/submit-consultant-bid`, {
        ...
        body: JSON.stringify({ token, _preflight: true }),
      });
  ...
  return (
    <div className="min-h-screen bg-background">
      <div className="max-w-2xl mx-auto px-4 py-12 sm:py-16">
        ...
        {state === "loading" && (
          <div className="bg-surface border border-border-subtle rounded-xl p-12 text-center shadow-soft">
        ...
        {(state === "ready" || state === "submitting") && (
          <div className="bg-surface border border-border-subtle rounded-xl shadow-soft overflow-hidden">
            ...
            {errorMessage && state === "ready" && (
              <div className="mx-6 mt-6 p-3 rounded-lg bg-destructive/5 border border-destructive/20">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-5">
              <div>
                ...
                {fieldErrors.proposedRate && (
                  <p className="text-xs text-destructive mt-1">{fieldErrors.proposedRate}</p>
                )}
              </div>
              ...
              <div>
                <TextInput
                  label="Product Name"
                  placeholder="e.g. 5-Year Fixed Rate Mortgage"
                  value={productName}
                ...
                {fieldErrors.productName && (
                  <p className="text-xs text-destructive mt-1">{fieldErrors.productName}</p>
                )}
              </div>
              ...
              <div>
                ...
                {fieldErrors.tenureMonths && (
                  <p className="text-xs text-destructive mt-1">{fieldErrors.tenureMonths}</p>
                )}
              </div>
              ...
              <div>
                <TextArea
                  ...
                  placeholder="Any terms, conditions, or details the client should know about..."
                  rows={4}
                  maxLength={2000}
                  value={advisorNotes}
