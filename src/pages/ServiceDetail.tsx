...
export function ServiceDetail() {
  return <main>
      <SEO title="Debt Management Services" description="Strategic restructuring and optimization of liabilities to preserve liquidity and enhance your overall net worth. Book a consultation with Safe Methods." path="/services" />
      {/* Banner Section */}
      <section className="bg-primary text-primary-foreground py-20 md:py-28 px-4 md:px-8 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <Button variant="secondary" size="lg" className="!border-accent !text-[#F7F3EA] hover:!bg-accent hover:!text-accent-foreground">
        ...
        <div className="lg:col-span-8 space-y-16">
          ...
          <div className="space-y-8">
            ...
            <ul className="space-y-6">
              {['Comprehensive liability audit and balance sheet analysis.', 'Strategic restructuring of existing credit facilities and mortgages.', 'Negotiation of favorable terms with premium lending institutions.', 'Liquidity optimization to ensure capital is deployed efficiently.', 'Ongoing monitoring and adjustment of debt strategies as markets evolve.'].map((item, idx) => <li key={idx} className="flex items-start gap-4">
        ...
        <div className="lg:col-span-4">
          <div className="sticky top-28">
            <Card floating className="border-t-4 border-t-accent">
              ...
              <CardFooter>
                <Button variant="primary" className="w-full group flex justify-center items-center">
      ...
      <section className="bg-surface py-20 md:py-28 border-t border-subtle">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="flex justify-between items-end mb-12">
            ...
            <a href="#" className="hidden md:flex items-center text-sm font-medium text-accent hover:text-primary transition-colors">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            excerpt: 'Understanding how high-net-worth individuals use debt as a tool for asset acquisition and tax efficiency.',
            date: 'October 12, 2023'
          }, {
            title: 'Navigating Interest Rate Volatility',
            excerpt: 'Strategies for protecting your portfolio and optimizing your liabilities in a shifting rate environment.',
            date: 'September 28, 2023'
          }, {
            title: 'Consolidating Complex Credit Facilities',
            excerpt: 'A case study on streamlining multiple lending relationships to reduce costs and improve liquidity.',
            date: 'August 15, 2023'
          }].map((article, idx) => <Card key={idx} className="h-full flex flex-col hover:shadow-raised transition-shadow cursor-pointer group">
