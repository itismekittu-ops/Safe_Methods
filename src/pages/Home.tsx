...
export function Home() {
  return <main>
      <SEO title="Compare Financial Advice from Top Institutions" fullTitle="Safe Methods | Compare Financial Advice from Top Institutions" description="Safe Methods connects you with financial experts from top institutions so you can compare and choose the best products, rates, and advice." path="/" />
      <Helmet>
