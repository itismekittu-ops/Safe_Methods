...
### 3.1 Rendering
**Requirement (`SEO-TECH-01`):** Server-side rendering or static prerendering for every public marketing route (home, about, contact, how-it-works, rates/compare, consultants, banks). Chat/authenticated routes may remain client-rendered.
